    ...
    <div className="flex flex-col min-h-screen relative overflow-hidden bg-[#080808] font-sans text-[#FAFAFA]">
      ...
      <section id="hero" aria-label="The main header and value proposition" className="relative flex flex-col items-center justify-center text-center px-4 pt-24 sm:pt-32 md:pt-40 pb-16 sm:pb-24 md:pb-32">
        ...
        >
          ...
          <span className="text-[#A1A1AA]">The Notion alternative for creators.</span>
        </motion.div>
        ...
        <motion.p 
          ...
          className="text-[18px] sm:text-[20px] md:text-[22px] text-[#A1A1AA] max-w-2xl mb-10 leading-relaxed font-medium tracking-tight"
        >
        ...
        >
          ...
          <Link to="/pricing" className="w-full sm:w-auto">
            <Button size="lg" variant="outline" className="w-full sm:w-auto h-12 rounded-[12px] px-8 border-white/[0.12] bg-[#111111]/50 hover:bg-white/[0.04] text-[#FAFAFA] font-medium text-[15px] backdrop-blur-sm transition-all duration-300">
              View Pricing
            </Button>
          </Link>
        </motion.div>
        ...
        <div className="mt-16 sm:mt-24 flex flex-wrap justify-center gap-x-8 gap-y-4 max-w-3xl">
          {[['Viral retention benchmark tool', 'Data-driven insights.'], ['Batch short-form script generator', 'Create weeks of content fast.'], ['Multi-brand social media calendar', 'The ultimate SMMA client content dashboard.']].map(([title, copy], index) => (
            <motion.div key={title} initial={reduceMotion ? false : { opacity: 0, y: 8 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.7 }} transition={{ duration: 0.32, delay: index * 0.07 }} className="px-4 py-1">
              <p className="text-[13px] font-medium text-[#FAFAFA]">{title}</p>
              <p className="mt-1 text-[12px] text-[#71717A]">{copy}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section id="features" className="py-16 sm:py-20 lg:py-24 px-4 bg-[#080808] relative z-10">
        <div className="max-w-6xl mx-auto">
          <motion.div initial={reduceMotion ? false : { opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.45 }} transition={{ duration: 0.42 }} className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <p className="text-[#A1A1AA] max-w-2xl mx-auto text-[17px] tracking-tight">The definitive UGC creator management system. Outputs automatically become inputs.</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 lg:gap-6">
            ...
            >
              ...
              <p className="text-[#A1A1AA] leading-relaxed text-[15px] tracking-tight">Learn exactly how to score video hooks before filming. Score and optimize hooks against top performing historical data. A powerful VidIQ hook alternative.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-[#A1A1AA] leading-relaxed text-[15px] tracking-tight">Platform-specific SEO captions generated instantly from your winning hooks. Your Opus Clip companion workflow.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-[#A1A1AA] leading-relaxed max-w-md text-[15px] tracking-tight">Plan launches, track production across your entire freelance video clipper pipeline, and review automated analytics all in one beautiful kanban board. The TubeBuddy alternative 2026.</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-28">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 max-w-xl sm:mb-14">
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-[#A1A1AA]">Creator OS keeps the work moving forward, so you can focus on the decisions that make your content distinct. The best content planner for TikTok clippers.</p>
          </div>
      ...
      <section id="pricing" aria-label="Creator ($29), Pro ($49), and Agency ($149) Tiers" className="relative px-4 pb-20 sm:px-6 sm:pb-28">
        <div className="mx-auto max-w-6xl overflow-hidden rounded-[24px] border border-primary/25 bg-[radial-gradient(ellipse_70%_120%_at_50%_0%,rgba(124,58,237,.24),transparent_65%),#111111] px-6 py-12 text-center sm:px-12 sm:py-16">
          ...
          <p className="mx-auto mt-4 max-w-xl text-[15px] leading-relaxed text-[#A1A1AA]">Start with the workflow you use today. Scale only when your short-form video editor software needs it.</p>
