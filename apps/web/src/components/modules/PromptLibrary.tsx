...
export function PromptLibrary() {
  ...
  return <div className="mx-auto max-w-5xl space-y-7 animate-in fade-in duration-500"><div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-end"><div><p className="text-[11px] font-semibold uppercase tracking-[.18em] text-primary">Intelligence</p><h2 className="mt-2 text-[26px] font-semibold tracking-tight text-[#FAFAFA]">Prompt Center</h2><p className="mt-1 text-sm text-[#71717A]">Your reusable creative instructions, saved to this workspace.</p></div><Button onClick={() => { setEditing(undefined); setEditorOpen(true); }}><Plus className="mr-1.5 h-4 w-4" />New prompt</Button></div>
