...
export function UpgradePrompt({
  ...
  if (effectiveHas) {
    return (
      <section className={compact
        ...
        : 'flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-2xl border border-primary/20 bg-primary/[0.03] p-5'}>
        ...
        {/* Buttons on the right for non-compact, or inline for compact */}
  ...
  return (
    <section className={compact
      ...
      : 'flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-2xl border border-primary/20 bg-primary/[0.05] p-5'}>
      <div className="flex items-start gap-3">
