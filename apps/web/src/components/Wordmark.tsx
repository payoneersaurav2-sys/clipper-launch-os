...
function WordmarkImage({ size = 'md', className }: Pick<WordmarkProps, 'size' | 'className'>) {
  return <img src="/brand/creator-os-wordmark-optimized.webp" alt="Creator OS" width={132} height={26} fetchPriority="high" loading="eager" className={cn('block h-auto select-none', sizeMap[size], className)} />;
}
